  ...
  theme: {
  	extend: {
  		...
  		colors: {
  			...
  			primary: {
  				DEFAULT: 'hsl(var(--aether-primary))',
            ...
            aether: {
              ...
              neutral: {
                ...
                foreground: 'hsl(210 4% 90%)'
              }
            },
            auth: {
              DEFAULT: 'hsl(210 4% 20%)',
              foreground: 'hsl(0 0% 98%)'
            }
  		},
  		boxShadow: {
  			soft: '0 2px 15px -3px rgba(0, 0, 0, 0.07), 0 10px 20px -2px rgba(0, 0, 0, 0.04)',
  			'soft-lg': '0 10px 30px -5px rgba(0, 0, 0, 0.1), 0 20px 40px -10px rgba(0, 0, 0, 0.05)',
  		...
  		backgroundImage: {
            ...
            'gradient-aether-hero': 'linear-gradient(135deg, hsl(250 80% 60%) 0%, hsl(280 70% 50%) 100%)'
  		}
  	}
  },
